// Semi working Sidebar fix by Bram
...
//document.querySelector("body > home-assistant").shadowRoot.querySelector("home-assistant-main").shadowRoot.querySelector("ha-drawer").shadowRoot.querySelector(".mdc-drawer").style.setProperty("background", "rgba(0,0,0,0.5)");
